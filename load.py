...
def getvarwindCV2 (dframe, chan, \
                   ...
                   lwinsz=[72.0, 32.0, 25.6, 10.7, 2.8, 2.8, 1.2],FoctTH=1.5,ERPscoreTH=0.8,ERPDurTH=(75,300)):
...
if __name__ == "__main__":
  ...
  try:
    print('fn is',fn,'getbipolar:',getbipolar,'winsz:', winsz, 'medthresh:', medthresh,'useCSD:',useCSD,'useDynThresh:',useDynThresh,'dolaggedcoh',dolaggedcoh,'mspecwidth:',mspecwidth,'docfc:',docfc,'dolaggedcohnoband:',dolaggedcohnoband,'dosim:',dosim,'endfctr:',endfctr)
  except:
    pass
  if dorun:
    ar = getAreaCode(fn)
